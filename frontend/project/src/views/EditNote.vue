<template>
  <div class="flex flex-col items-center h-screen pt-2 relative">
    <div class="flex items-center justify-between w-full mb-12 px-8">
      ...
      <h1 class="font-black text-xl text-white">
        {{ is_edit ? "Edit Note" : "Create Note" }}
      </h1>
      <p></p>
    </div>
    ...
    <div class="fixed bottom-0 right-0 z-50 mr-8 mb-4">
      ...
      <v-btn color="#700a08" rounded="lg" @click="Save()"> Save </v-btn>
    </div>
  </div>
</template>
...
import { getNote, updateNote, createNote } from "/src/services/noteService";
